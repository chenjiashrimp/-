...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        if who==1:
             new_high=score1-last_score
        else:
            new_high=score0-last_score
        if new_high>running_high:
            print(f"{new_high} point(s)! That's a record gain for Player {who}!")
            if who==1:
                 return announce_highest(who,score1,new_high)
            else:
                return announce_highest(who,score0,new_high)
        if who==1:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for n in range(1,11):
        ...
        new_score=averaged_roll_dice(n,dice)
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    new_score=score
    new_score+=picky_piggy(opponent_score)
    if new_score==opponent_score:
        return 0
    elif picky_piggy_strategy(score, opponent_score,cutoff,num_rolls)==0:
        return 0
    else:
        return num_rolls
     # Remove this line once implemented.
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    cutoff=8
    num_rolls=6
    num_rolls=hog_pile_strategy(score, opponent_score,cutoff,num_rolls)
    if num_rolls==0:
        return 0
    averaged_roll_dice=make_averaged(roll_dice,1000)
    rest_score1=averaged_roll_dice(1,six_sided)
    #print(rest_score1)
    rest_score2=averaged_roll_dice(2,six_sided)
    #print(rest_score2)
    if score+rest_score1>=100:
        return 1
    elif score+rest_score2>=100:
        return 2
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 12
#print(final_strategy(95, 0))
